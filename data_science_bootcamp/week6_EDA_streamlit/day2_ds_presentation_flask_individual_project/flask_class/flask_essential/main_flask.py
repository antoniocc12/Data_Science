...
import os
#cada una de las funciones que creamos o de las / algo son funciones endpoint
# Mandatory
...
def home():
    """ Default path """
    return app.send_static_file('greet.html')#que se cargue por defecto un archivo llamado greet
@app.route("/greet")
def greet():
